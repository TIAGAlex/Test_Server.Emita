...
_role1 = "Welcome %1"; //In yellow
_role1names = ["This Is Arma Gaming - Altis life"]; //In white
_role2 = "Police and EMS must join our teamspeak";
_role2names = ["TIAG.ts3dns.com"]; 
_role3 = "please make sure you have read the rules at";
_role3names = ["ThisIsArma.tk"];
_role4 = "Apply for police/swat or staff at";
_role4names = ["TIAG.enjin.com"];
_role5 = "Website and teamspeak";
_role5names = ["ThisIsArma.tk - TIAG.ts3dns.com"];
_role6 = "Donations accepted at";
_role6names = ["ThisIsArma.TK"];
