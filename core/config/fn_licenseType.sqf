...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "methl": {_var = "license_civ_methl"};  // in the upper field
			case "methm": {_var = "license_civ_methm"};
			case "methb": {_var = "license_civ_methb"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_methl": {_var = "methl"};  // in the lower field
			case "license_civ_methm": {_var = "methm"};
			case "license_civ_methb": {_var = "methb"};
