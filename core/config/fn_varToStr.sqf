...
switch (_var) do
{
    ...
    case "life_inv_methl": {(localize "STR_Item_methl")};
	case "life_inv_methm": {(localize "STR_Item_methm")};
	case "life_inv_methb": {(localize "STR_Item_methb")};
	...
	case "license_civ_methl": {(localize "STR_License_methl")};
	case "license_civ_methm": {(localize "STR_License_methm")};
	case "license_civ_methb": {(localize "STR_License_methb")};
	case "license_civ_passport": {(localize "STR_passport")};
};
