...
switch (playerSide) do
{
	case west: 
	{
		...
		life_paycheck = 1100; //Paycheck Amount
	};
	case civilian: 
	{
		life_atmcash = 100000; //Starting Bank Money
		life_paycheck = 540; //Paycheck Amount
	};
...
[
	...
	["license_civ_methl","civ"],
	["license_civ_methm","civ"],
	["license_civ_methb","civ"]
];
...
//[shortVar,reward]
life_illegal_items = [["heroinu",1200],["heroinp",2500],["cocaine",1500],["cocainep",3500],["marijuana",2000],["turtle",3000],["blastingcharge",10000],["boltcutter",500],["methu",400],["methl",2000],["methm",4000],["methb",6000]];
